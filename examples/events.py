...
@client.event
@coc.ClanEvents.member_versus_trophies(clan_tags)
...
async def on_player_donation(old_player, new_player):
    ...
    print(f"{new_player} of {new_player.clan} just donated {final_donated_troops} troops.")
...
async def on_player_donation_receive(old_player, new_player):
    ...
    print(f"{new_player} of {new_player.clan} just received {final_received_troops} troops.")


@client.event
@coc.PlayerEvents.trophies(tags=player_tags)
async def on_player_trophy_change(old_player, new_player):
    print(f"{new_player} trophies changed from {old_player.trophies} to {new_player.trophies}")


@client.event
@coc.PlayerEvents.versus_trophies(tags=player_tags)
async def on_player_versus_trophy_change(old_player, new_player):
    print(f"{new_player} versus trophies changed from {old_player.trophies} to {new_player.trophies}")
