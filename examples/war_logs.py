...
async def test_generators(client: coc.Client, clan_tag: str):
    ...
    warlogs_with_page = await client.get_warlog(clan_tag, paginate=True, limit=2)
...
async def main():
    ...
    await test_generators(coc_client, "#2Y28CGP8")
