...
+----------------------------------------------+----------------------+
| :ref:`on_clan_update`                        | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_level_change`                  | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_description_change`            | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_public_war_log_change`         | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_type_change`                   | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_badge_change`                  | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_required_trophies_change`      | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_war_frequency_change`          | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_war_win_streak_change`         | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_war_win_change`                | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_war_tie_change`                | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_war_loss_change`               | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_join`                   | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_leave`                  | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_name_change`            | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_donation`               | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_received`               | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_role_change`            | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_rank_change`            | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_clan_member_level_change`           | ``clan``             |
+----------------------------------------------+----------------------+
| :ref:`on_war_update`                         | ``war``              |
+----------------------------------------------+----------------------+
| :ref:`on_war_attack`                         | ``war``              |
+----------------------------------------------+----------------------+
| :ref:`on_war_state_change`                   | ``war``              |
+----------------------------------------------+----------------------+
| :ref:`on_player_update`                      | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_name_change`                 | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_townhall_upgrade`            | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_builderhall_upgrade`         | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_best_trophies_change`        | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_best_versus_trophies_change` | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_war_stars_change`            | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_attack_wins_change`          | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_defense_wins_change`         | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_versus_attacks_change`       | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_trophies_change`             | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_league_change`               | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_role_change`                 | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_donations_change`            | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_received_change`             | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_clan_rank_change`            | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_previous_clan_rank_change`   | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_achievement_change`          | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_troop_upgrade`               | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_spell_upgrade`               | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_hero_upgrade`                | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_clan_join`                   | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_clan_leave`                  | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_player_clan_level_change`           | ``player``           |
+----------------------------------------------+----------------------+
| :ref:`on_clan_badge_change`                  | ``player``           |
+----------------------------------------------+----------------------+
